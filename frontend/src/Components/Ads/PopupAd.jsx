      ...
      <div className="popup-ad">
        ...
        <div className="popup-ad-content">
          <div className="popup-ad-image">
            <img 
              src={localAd.imageUrl ? (localAd.imageUrl.startsWith('http') ? localAd.imageUrl : `http://localhost:4000/${localAd.imageUrl}`) : gymImage1} 
              alt={localAd.title} 
            />
          </div>
          <div className="popup-ad-info">
            ...
            {typeof localAd.clicks === 'number' && (
              <div className="popup-ad-clicks">Clicks: {localAd.clicks}</div>
            )}
          </div>
        </div>

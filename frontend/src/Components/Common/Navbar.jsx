              ...
              <div className="navbar-auth">
                {user ? (
                  <Menu as="div" className="user-menu">
                    <Menu.Button className="user-menu-button enhanced-profile">
                      <span className="user-name enhanced-profile-name">{user.name}</span>
                      <span className="enhanced-profile-icon-wrapper">
                        <UserCircleIcon className="profile-icon enhanced-profile-icon" aria-hidden="true" />
                      </span>
                    </Menu.Button>
                    <Transition
                      as={Fragment}

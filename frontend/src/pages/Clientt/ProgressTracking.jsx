...
const ProgressTracking = () => {
    ...
    const renderWorkoutLogs = () => (
        ...
        <div className="progress-section">
            <div className="section-header" >
                <h3>Workout Logs</h3>
                <button className="dashboard-btn-primary" onClick={() => setIsLogFormOpen(true)}>
                    <FaPlus />
                    Add Workoutlog
                </button>
            </div>
    ...
    const renderBMITracking = () => (
        <div className="progress-section">
            <div className="section-header">
                <h3>BMI Tracking</h3>
                <button className="dashboard-btn-primary" onClick={() => setIsBmiFormOpen(true)}>
                    <FaPlus />Update BMI
                </button>
            </div>
            <div className="bmi-container">
                <div className="current-bmi">
                    ...
                    <div className="bmi-value">
                        {fitnessData.bmi[2].bmi.toFixed(1)}
                        <span className="bmi-status" style={{ color: calculateBMIStatus(fitnessData.bmi[2].bmi).color }}>
                            {calculateBMIStatus(fitnessData.bmi[2].bmi).status}
                        </span>
                    </div>
                    <div className="bmi-details">
                        <span>Weight: {fitnessData.weight}kg</span>
                        <span>Height: {fitnessData.height}cm</span>
                    </div>
                </div>
    ...
    const renderFitnessGoals = () => (
        <div className="progress-section">
            <div className="section-header">
                <h3>Fitness Goals</h3>
                <button className="dashboard-btn-primary" onClick={() => setIsFormOpen(true)}>
                    <FaPlus />Add Fitness Goal
                </button>
            </div>
                    ...
                    (fitnessData.fitnessGoals.map((goal, index) => (
                        <div key={index} className="goal-card">
                            <div className="goal-header">
                                <h4>{goal.goal}</h4>
                                <button className="icon-button" onClick={() => handleEditGoal(goal)}>
                                    <FaEdit />
                                </button>
                            </div>

        ...
        <div className="modal-overlay" onClick={handleCloseModal}>
          <div className="modal-content" onClick={e => e.stopPropagation()}>
            ...
            <div className="modal-details">
              <div><b>Date:</b> {selectedSession.date}</div>
              <div><b>Time:</b> {selectedSession.time}</div>
              <div><b>Location:</b> {selectedSession.location}</div>
              <div><b>Type:</b> {selectedSession.type}</div>
              <div><b>Description:</b> {selectedSession.description}</div>
              <div><b>Status:</b> <span style={{ color: statusColors[selectedSession.status] }}>{selectedSession.status}</span></div>
            </div>
          </div>
        </div>
      )}

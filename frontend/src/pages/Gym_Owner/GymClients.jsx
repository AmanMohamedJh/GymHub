...
function GymClients() {
  ...
  const handleDelete = async (id) => {
    ...
    try {
      ...
      if (selectedClient && selectedClient._id === id) handleCloseDrawer();
    } catch (err) {
              ...
              <tbody>
                {filteredClients.map((client) => (
                  <tr
                    key={client._id}
                    className={
                      client.needsAttention ? "row-attention-modern" : ""
                    }
                  >
                    <td>
                      <input
                        type="checkbox"
                        checked={selectedRows.includes(client._id)}
                    ...
                    <td>{client.fitnessGoals}</td>
                    <td>{client.fitnessLevel}</td>
                    <td>
                      <select
                        value={client.status}
                    ...
                    <td>
                      ...
                      <button className="action-btn-modern edit" title="Edit">
                        <FaEdit />
                      </button>
                      <button
                        className="action-btn-modern remove"
